'use strict';Object.defineProperty(exports, '__esModule', { value: true });exports.stateWithUpdate = stateWithUpdate;exports.stateWithDelete = stateWithDelete;function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _util = require(

'./util');var _ = require('lodash');

function stateWithUpdate(_x2, _x3, _x4) {var _arguments = arguments;var _again = true;_function: while (_again) {var state = _x2, path = _x3, changedProperties = _x4;deletedProperties = 
    currentObject = 
