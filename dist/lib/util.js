...
isObject = isObject;function functionize(object, defaultMethod, methods) {// turn the object into a function that calls a chosen method by default
  ...
  methods.map(function (methodName) {fn[methodName] = function () {for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}return object[methodName].apply(object, args);};}); // remember what we're based on
  fn.base = object; // return!
