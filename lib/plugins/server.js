...
import {COMMAND, INTENT, parseMessage, BUILTIN_COMMANDS, deserializeArguments, serializeArguments} from "./client-server-base";
...
class ServerPlugin {
  ...
  applyIntent(client, [code, intentName, objectPath, args]) {
